...
function Login({ goToSignup, goToForgotPassword }) {
  const { login } = useAuth();
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button type="button" onClick={() => goToForgotPassword?.()} className="text-xs text-gray-500 underline ml-auto">Forgot password?</button>
            </div>
